...
interface WhatsAppPriceButtonProps {
  packageName?: string;
  message?: string;
  label?: string;
  className?: string;
...
export const WhatsAppPriceButton: React.FC<WhatsAppPriceButtonProps> = ({
  ...
  const defaultMsg = packageName
    ? `Hi, I'm interested in the package: ${packageName}. Please share more details.`
    : "Hi! I need price & itinerary details for travel package.";
...
export default WhatsAppPriceButton;
